...
/**
 * The Hand class represents a dealt hand of cards
...
public class Hand {
	...
	public Hand(Deck deck) {
		...
		if(ranks[1] == 1){
			orderedRanks[index]=14;//record an ace as 14 instead of one
			index++;  
		}
		//check all other cards, store by highest value first 
		for (int i = 13; i >= 2; i--) {
			if (ranks[i]==1) {
